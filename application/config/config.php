...
|
*/
$config['base_url'] = 'http://localhost/vestibular/';
...
|--------------------------------------------------------------------------
|
| Aqui definimos as constantas relacionadas a erros lançados e definimos
| os principais métodos que usaremos para informar erros que ocorreram.
*/
